...
//
//// Senkron İşlemlerde (WebFlux olmasaydı) Kullanılacak Converter Örneği
//public class SynchronousCustomJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
...
//
//        return new CustomAuthenticationToken(username, name, familyName, email, authorities);
//    }
//
